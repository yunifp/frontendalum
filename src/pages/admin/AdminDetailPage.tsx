...
import {
    ArrowLeft, Users, GraduationCap, MapPin, Briefcase, Loader2, Save
} from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* BAGIAN KIRI: Form Edit Data RBAC */}
                ...
                {/* BAGIAN KANAN: Read-Only Data Master Service */}
                <div className="lg:col-span-2 space-y-6">
                        ...
                        <CardContent className="p-6 flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-3 mt-2">
                                    <Badge variant="outline" className="bg-slate-50">Role: {detailData.role}</Badge>
                  ...
                  `}>
                    ...
                    <Card className="shadow-sm border-slate-100 rounded-2xl">
                        <CardHeader className="bg-slate-50/50 border-b border-slate-100 pb-4">
                            <CardTitle className="text-sm font-bold text-slate-700 flex items-center gap-2">
                                <GraduationCap className="w-4 h-4 text-emerald-500" /> Data Akademik & Profil (Master Service)
                            </CardTitle>
                            <p className="text-xs text-slate-500 mt-1">Read-only. Dikelola langsung oleh pengguna terkait.</p>
                        </CardHeader>
                        <CardContent className="pt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-slate-900 bg-slate-50 p-2 rounded-md border border-slate-100">{detailData.profile?.graduationYear || 'Belum diisi'}</p>
                            </div>
                            <div>
                                <p className="text-slate-500 text-xs mb-1">Tanggal Lahir</p>
                                <p className="font-medium text-slate-900 bg-slate-50 p-2 rounded-md border border-slate-100">{detailData.profile?.birthDate || 'Belum diisi'}</p>
                            </div>
                            <div className="md:col-span-2">
                                <p className="text-slate-500 text-xs mb-1 flex items-center gap-1"><MapPin className="w-3 h-3" /> Alamat Domisili</p>
                                <p className="font-medium text-slate-900 bg-slate-50 p-3 rounded-md border border-slate-100">{detailData.profile?.address || 'Belum diisi'}</p>
                            </div>
                        </CardContent>
                    </Card>

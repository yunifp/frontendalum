    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-slate-900">Manajemen Event</h1>
                    <p className="text-sm text-slate-500">Kelola agenda dan event kampus terbaru.</p>
                </div>
                <Button
                            ...
                            <TableRow>
                                <TableCell colSpan={5} className="text-center py-20">
                                    <div className="flex flex-col items-center gap-2">
                                        ...
                                        <p className="text-xs text-slate-400 font-medium tracking-wide">Memuat data event...</p>
                                    </div>
                                </TableCell>
                            </TableRow>
                                    ...
                                    <TableCell className="px-4 py-3 align-middle text-right">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                <DropdownMenuItem 
                                                    onClick={() => navigate(`/admin/events/edit/${post.id_post}`, { state: { post } })}
                                                    className="cursor-pointer"
                                                >
                                                    <Edit2 className="w-4 h-4 mr-2 text-indigo-600" /> Ubah Event
                                                </DropdownMenuItem>
                                                <DropdownMenuItem 
                            ...
                            <TableRow>
                                <TableCell colSpan={5} className="h-48 text-center">
                                    <div className="flex flex-col items-center justify-center space-y-3">
                                        ...
                                        <p className="text-sm font-semibold text-slate-700">Tidak ada event ditemukan</p>
                                    </div>
                                </TableCell>
                            </TableRow>
                        )}
            ...
            <div className="flex items-center justify-between px-2 py-2 border-t pt-4">
                <div className="text-xs text-slate-500">Total {posts.length} event</div>
            ...
            <Dialog open={deleteModal.isOpen} onOpenChange={(val) => !val && setDeleteModal({ ...deleteModal, isOpen: false })}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogTitle className="text-center text-xl">Hapus Event?</DialogTitle>
                        <DialogDescription className="text-center pt-2">
                            Tindakan ini tidak dapat dibatalkan. Event berjudul <strong className="text-slate-900">"{deleteModal.title}"</strong> akan dihapus secara permanen dari database.
                        </DialogDescription>
                    </DialogHeader>
